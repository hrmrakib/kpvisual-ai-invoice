...
- Total Amount: ${analysisResult.amount}
...
Report ID: ${Date.now()}
    ...
    a.href = url;
    a.download = `invoice-analysis-${analysisResult.invoiceNumber.replace(
      "#",
      ""
    )}-${Date.now()}.txt`;
  ...
  const getAnalysisSummary = (result: InvoiceAnalysisResult): string => {
    switch (result.status) {
      case "verified":
        return "The invoice has passed all verification checks and appears to be authentic. Document structure, formatting, and content are consistent with legitimate invoices.";
      case "fake":
        return "The invoice has failed multiple verification checks and appears to be fraudulent. Significant inconsistencies detected in document structure and content.";
      case "suspicious":
        return "The invoice shows some irregularities that require manual review. While not definitively fraudulent, certain elements raise concerns.";
      default:
        return "Analysis completed with standard verification protocols.";
    }
  };

  const getRiskAssessment = (result: InvoiceAnalysisResult): string => {
    if (result.confidence >= 80) {
      return "LOW RISK - High confidence in analysis results.";
    } else if (result.confidence >= 60) {
      return "MEDIUM RISK - Moderate confidence, recommend additional verification.";
    } else {
      return "HIGH RISK - Low confidence, manual review strongly recommended.";
    }
  };

  const getRecommendations = (result: InvoiceAnalysisResult): string => {
    switch (result.status) {
      case "verified":
        return "• Invoice can be processed normally\n• No additional verification required\n• Archive for record keeping";
      case "fake":
        return "• DO NOT PROCESS this invoice\n• Report to fraud prevention team\n• Investigate vendor relationship\n• Consider legal action if necessary";
      case "suspicious":
        return "• Hold invoice for manual review\n• Contact vendor for verification\n• Request additional documentation\n• Escalate to supervisor if needed";
      default:
        return "• Follow standard processing procedures";
    }
  };
  ...
  return (
    <div className='min-h-[84vh] bg-[#E9E9E9] flex flex-col justify-center items-center'>
      <main className='container mx-auto px-4 py-8 md:py-12'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-48'>
          {/* Left column - Analysis results */}
          <div className='lg:col-span-1 space-y-8'>
            <div className='mb-8 md:mb-12'>
              <h1 className='max-w-lg text-3xl md:text-4xl lg:text-[60px] font-bold text-[#101010] mb-4'>
            ...
            <div className='bg-[#E9E9E9] rounded-2xl'>
              ...
              <div className='mb-6'>
                ...
                <div className='w-full bg-gray-200 rounded-full h-2'>
                  <div
                    className={`h-2 rounded-full transition-all duration-1000 ${getConfidenceColor(
                      analysisResult.confidence
                    )}`}
              ...
              <div className='flex items-center gap-6 md:gap-12 text-gray-900'>
                <div className='space-y-4'>
                  <div>
                    ...
                    <span className='font-semibold text-lg text-[#6E6E6E]'>
                      #INV-94218
                    </span>
                  </div>
                  <div>
              ...
              <div className='flex flex-col sm:flex-row gap-4 mt-10'>
                {/* <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8'>
                  ...
                  <div
                    className={`relative border-2 border-dashed rounded-xl p-6 md:p-8 transition-all duration-200 ${
                      dragActive
                  ...
                  >
                    ...
                    <div className='flex flex-col items-center space-y-4'>
                      ...
                      <button
                        ...
                        disabled={isUploading}
                        className='bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 md:px-8 md:py-3 rounded-full text-sm md:text-base transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
                      >
          ...
          <div className='lg:col-span-1'>
            <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8 h-fit'>
              <div className='text-center'>
                ...
                {/* Mock invoice preview placeholder */}
